function Create(self)
	...
	self.strength = self.Mass * 160;
	self.range = self.Lifetime * 160;
	
	self.shakenessParticle = CreateMOPixel("Shakeness Particle Frostbite", "Frostbite.rte");
	self.extraSmokeParticle = CreateMOPixel("Indoor Payload RINOBI Hunter", "Frostbite.rte");

	self.explodeOutdoorsSound = CreateSoundContainer("Explode Outdoors RINOBI Hunter", "Frostbite.rte");
	self.explodeIndoorsSound = CreateSoundContainer("Explode Indoors RINOBI Hunter", "Frostbite.rte");
	
	self.shakenessParticle.Pos = self.Pos;
	self.shakenessParticle.Mass = 45;
	self.shakenessParticle.Lifetime = 450;
